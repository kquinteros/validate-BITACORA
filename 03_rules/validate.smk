...
rule exclude_sequences:
    ...
    output:
        "05_output/{sam}/{pro}/validated/{pro}_genomic_and_annotated_proteins_trimmed_idseqsclustered_excluded.gff3"
    params:
...
rule ensure_feature_names:
    ...
    shell:
        ...
        """
###--- Ensure that GFF does not have duplicate and fixes ID issues  ---###
